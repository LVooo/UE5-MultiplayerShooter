...
void UCombatComponent::Fire()
{
	if (CanFire())
	{
		...
		if (EquippedWeapon)
		{
			...
			{
			case EFireType::EWT_Projectile:
				FireProjectileWeapon();
				break;
			case EFireType::EWT_HitScan:
				FireHitScanWeapon();
				break;
			case EFireType::EWT_Shotgun:
				FireShotgun();
				break;
			}
